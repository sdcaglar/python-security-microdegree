...
## python3 SerialConverter.py --serial FOC010203H8
## python3 SerialConverter.py --serial FOC020803H8
        ...
        if self.pattern.match(self.serial):
            ...
            if self.year.match(self.serial[3:5]):
                ...
                if self.month.match(self.serial[5:7]):
                    ...
                    print("Could not identify the month of manufactuing!")
            else:
                print("Could not identify the year of manufactuing!")
        else:
